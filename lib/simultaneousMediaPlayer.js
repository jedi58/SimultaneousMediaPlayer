var MultiTrackMediaPlayer = {
    ...
    addPlayer: function(id, filenames)
    {
        ...
        $('#' + id  + ' .player__control-play').click(function() { MultiTrackMediaPlayer.playTracks(id); });
        $('#' + id  + ' .player__control-pause').click(function() { MultiTrackMediaPlayer.stopAll(); });
    },
